<div class="bg-primary-400 text-white">
    <div class="w-full py-6 px-5 lg:max-w-[1440px] m-auto flex flex-col gap-6 items-center lg:flex-row  lg:pl-20">
        <div class="flex gap-4 flex-col">
            <h1 class="display-md-medium">{{ $sekcjeHero['tytul']}}</h1>
            <p class="text-md-regular">{{$sekcjeHero['podtytul']}}</p>
            <x-button variant="outline" size='md' class="bg-orange-400 w-fit"> 
